...
<div class="panel">
    ...
    $('#sp_price').val(str);
                    ...
                    <input type="text" id="sp_price" readonly="" name="sp_price" />
<select id="dropdown_test" onchange="calc()">
    ...
    <option value="R" data-one="0" data-two="0.9">EF : prix de base / 0.85</option>
    <option value="U" data-one="0.5" data-two="0.65">PART : (prix de base + 0.48) / 0.65</option>
