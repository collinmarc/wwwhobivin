...
<div class="panel">
    ...
    var select1_control = {$product->price};
    var str = (select1_control + $(this).find('option:selected').data('one')) /  $(this).find('option:selected').data('two');
    $('#sp_price').val(str);
});
                                </script>
                    <input type="text" id="sp_price" readonly="true" name="sp_price" />
<select id="dropdown_test" onchange="calc()">
    <option value="N" data-one="0.35" data-two="0.8">CHR : (prix de base / 0.8)+0.35</option>
    <option value="G" data-one="0" data-two="0.8">EF : prix de base / 0.8</option>
    <option value="O" data-one="0.45" data-two="0.6">PART : (prix de base + 0.45) / 0.60</option>
    <option value="A" data-one="0.35" data-two="0.75">CHR : (prix de base + 0.35) / 0.75</option>
    <option value="R" data-one="0" data-two="0.85">EF : prix de base / 0.85</option>
    <option value="U" data-one="0.48" data-two="0.65">PART : (prix de base + 0.48) / 0.65</option>
