...
return array("DROP TABLE IF EXISTS
                `" . $prefix . "customerattributes_lang`,
                `" . $prefix . "customerattributes`,
    		    `" . $prefix . "customerattributes_section_lang`,
                `" . $prefix . "customerattributes_shop`,
                `" . $prefix . "customerattributes_section`,
                `" . $prefix . "customerattributes_customer`;");
